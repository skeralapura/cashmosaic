...
const CELL = 11;
const GAP  = 2;
const COL  = CELL + GAP; // pixels per week column
    ...
    <div className="card p-5">
      ...
      {isLoading ? (
        ...
        <div className="overflow-x-auto pb-2">
          <div className="inline-flex flex-col" style={{ gap: 6 }}>

            {/* Month labels */}
            <div className="relative" style={{ height: 14, marginLeft: 32 }}>
              ...
              {Array.from({ length: numWeeks }, (_, wi) => (
                <div key={wi} className="flex flex-col" style={{ gap: GAP }}>
                  {Array.from({ length: 7 }, (_, di) => {
                    ...
                    // Padding cell (before startDate or after endDate)
            ...
            {/* Legend */}
            <div className="flex items-center gap-2 mt-1" style={{ marginLeft: 32 }}>
